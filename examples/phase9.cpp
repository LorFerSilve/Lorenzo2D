...
class Phase9Example final : public l2d::Application
{
  public:
    Phase9Example()
        : l2d::Application(800, 450, "Lorenzo2D phase 9 | Click a diamond to place")
    {
  ...
  private:
    ...
    l2d::Scene m_scene{"Phase 9 isometric"};
