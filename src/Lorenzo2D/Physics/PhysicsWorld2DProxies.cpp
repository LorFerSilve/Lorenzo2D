...
namespace l2d
{
    namespace
    {
        ...
        )
        {
            if (collider.type() == ColliderType::Box)
            {
                const BoxCollider2D* box =
                    dynamic_cast<const BoxCollider2D*>(&collider);
        ...
        bool physicsProxyLess(
            const detail::PhysicsProxy2D& left,
    ...
    PhysicsWorld2D::BroadPhaseStepData2D
    PhysicsWorld2D::buildBroadPhaseStepData(Scene& scene) const
    {
        ...
        std::sort(
            stepData.proxies.begin(),
            stepData.proxies.end(),
            physicsProxyLess
        );
        ...
        stepData.stats.bruteForcePairCount =
        ...
        {
            stepData.broadPhaseResult = detail::buildUniformGridPairs(
                broadPhaseProxies,
        ...
        stepData.stats.occupiedCellCount =
            stepData.broadPhaseResult.occupiedCellCount;
        stepData.stats.fallbackProxyCount =
            stepData.broadPhaseResult.fallbackProxyCount;
        stepData.stats.candidatePairCount =
            stepData.broadPhaseResult.pairs.size();
