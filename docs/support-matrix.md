...
| Orthogonal top-down | Planned | orthogonal tilemap, WASD-capable input, sprites, animation, sensors, and camera primitives | top-down/grid controllers, tile triggers, layered content model and focused template |
| Point-and-click movement | Planned | pointer world coordinates and movement/physics primitives | physics queries, navigation grid, A*, path following, avoidance and focused template |
