...
| Point-and-click movement | Planned | unified pointer state, camera-aware world coordinates, drag state, and movement/physics primitives | physics queries, navigation grid, A*, path following, avoidance and focused template |
