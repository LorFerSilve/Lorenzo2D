...
foreach(l2d_file IN LISTS l2d_format_files)
    ...
    if(NOT l2d_result EQUAL 0)
        ...
        if(l2d_file MATCHES "ComponentInspectorControls\\.cpp$")
            execute_process(
                COMMAND "${L2D_CLANG_FORMAT_EXECUTABLE}" "${l2d_file}"
                OUTPUT_VARIABLE l2d_expected_format
            )
            message(STATUS "Expected clang-format output BEGIN\n${l2d_expected_format}Expected clang-format output END")
        endif()
    endif()
endforeach()
